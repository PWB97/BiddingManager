                ...
                <%
                    if (Identify.equals("ManagerUser")) {
                        out.print("<li><a href='/UserManagerServlet'><i class='fa fa-user'></i> <span>企业用户管理</span></a></li><li><a href='/GovernmentManagerServlet'>" +
                                ...
                                "                        <i class='fa fa-globe'></i> <span>企业管理</span></a></li><li class='active'><a href='/ProjectManagerServlet'>" +
                                "                        <i class='fa fa-envelope'></i> <span>招商信息</span></a></li><li><a href='/NewsManagerServlet'>" +
                                "                        <i class='fa fa-envelope'></i> <span>新闻信息</span></a></li><li><a href='/BiddingManagerServlet'>" +
                                "                        <i class='fa fa-envelope'></i> <span>投标信息</span></a></li>");
                    } else if (Identify.equals("GovernmentUser")){
                        out.print("<li class='active'><a href='/ProjectManagerServlet'><i class='fa fa-envelope'></i><span>招商信息</span></a></li><li><a href='/NewsManagerServlet'><i class='fa fa-envelope'></i><span>新闻信息</span></a></li><li><a href='/BiddingManagerServlet'><i class='fa fa-envelope'></i> <span>投标信息</span></a></li>");
                    }
                %>
            </ul>
        </section>
                ...
                <div class="panel-body" style="background-color: #f0f3f4">
                    <div class="tab-content">
                        <div id="manager" class="tab-pane active">
                            <div class="row">
                                <section class="panel">
                                    ...
                                    <c:set var="proList" value="${requestScope.pm.projectList}"/>
                                    <header class="panel-heading">项目表</header>
                                    <form id="form2" name="form2" action="">
                                        <div class="panel-body table-responsive">
                                            <table class="table table-hover text-center">
                                                ...
                                                <tbody>
                                                <c:forEach var="pro" items="${proList}" varStatus="s">
                                                    <tr id="">
                                                        <td>${pro.PID}
                                                            <input type="hidden" name="PID" disabled="disabled"
                                                                   value="${pro.PID}"></td>
                                                        <td>${pro.APPLICANT}</td>
                                                        <td>${pro.PNAME}</td>
                                                        <td>${pro.PCONTENT}</td>
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <button id="delete" type="button" class="btn btn-default"
                                                                        onclick="deleteProject(this)"><i class="fa fa-times"></i>
                                                                </button>
                                                                <a type="button" href="changeProjectServlet?PID=${pro.PID}"
                                    ...
                                    <div class="text-center">
                                        <nav>
                                            <ul class="pagination myPagination">
                                                <li class="page-item">
                                                    <a class="page-link"
                                                       href="<c:url value="/ProjectManagerServlet?currentPage=1"/>">首页</a>
                                                </li>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                       href="<c:url value="/ProjectManagerServlet?currentPage=${currentPage-1>1?currentPage-1:1}"/>"
                                                       aria-label="Previous">
                                                ...
                                                <c:forEach begin="1" end="${totalPages}" varStatus="s">
                                                    ...
                                                    <li class="page-item ${active}">
                                                        <a class="page-link"
                                                           href="<c:url value="/ProjectManagerServlet?currentPage=${s.index}"/>">${s.index}</a>
                                                    </li>
                                                </c:forEach>
                                                <li class="page-item">
                                                    <a class="page-link"
                                                       href="<c:url value="/ProjectManagerServlet?currentPage=${currentPage+1<totalPages?currentPage+1:totalPages}"/> "
                                                       aria-label="Next">
                                                ...
                                                <li class="page-item">
                                                    <a class="page-link"
                                                       href="<c:url value="/ProjectManagerServlet?currentPage=${totalPages}"/> ">尾页</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </div>
                        ...
                        <div id="add" class="tab-pane">
                            <div class="row">
                                <section class="panel">
                                    <form action="addProjectServlet" method="post" class="panel-body">
                                        ...
                                        <br>
                                        <br>
                                        <label class="l1">项目名称</label>
                                        <input id="projectName" name="projectTitle" class="form-control">
                                        <label class="l1">项目内容</label>
                                        <!-- 加载编辑器的容器 -->
                                        <script id="container" name="contentProject" type="text/plain">
                                        </script>
                                    </form>
                                </section>
                            </div>
