            ...
            <ul class="sidebar-menu">
                <%
                    if (Identify.equals("ManagerUser")) {
                        ...
                        out.print("<li class='active'><a href='/ProjectManagerServlet'><i class='fa fa-globe'></i><span>招商信息</span></a></li><li><a href='/NewsManagerServlet'><i class='fa fa-glass'></i><span>新闻信息</span></a></li><li><a href='/BiddingManagerServlet'><i class='fa fa-glass'></i> <span>投标信息</span></a></li>");
                    }
                %>
            </ul>
        </section>
            ...
            <section class="panel general">
                <header class="panel-heading tab-bg-dark-navy-blue">
                    <ul class="nav nav-tabs">
                        <li >
                            <a  href="/ProjectManagerServlet">管理</a>
                        </li>
                        <li class="active">
                            ...
                            <div class="row">
                                ...
                                <section class="panel">
                                    <form action="addProjectServlet" method="post" class="panel-body">
                                        ...
                                        <input id="projectName" name="projectTitle" class="form-control" value="${project.PNAME}">
                                        <label class="l1">项目内容</label>
                                        <!-- 加载编辑器的容器 -->
                                        <script id="container" name="contentProject" type="text/plain">${project.PCONTENT}</script>
                                    </form>
                                </section>
                            </div>
                        </div>
