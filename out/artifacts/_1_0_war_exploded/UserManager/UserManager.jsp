                        ...
                        <div id="manager" class="tab-pane active">
                            <div class="row">
                                <section class="panel">
                                    ...
                                    <c:set var="userList" value="${requestScope.pm.userList}"/>
                                        ...
                                        <div class="panel-body table-responsive">
                                            <table class="table table-hover text-center">
                                                ...
                                                <c:forEach var="user" items="${userList}" varStatus="s">
                                                    <tr id="">
                                                        <td>${user.uName}
                                                            <input type="hidden" name="uName" disabled="disabled" value="${user.uName}">
                                                        </td>
                                                        <td>${user.uSex}</td>
                                                        <td>${user.uAge}</td>
                                                        <td>${user.uTel}</td>
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <button class="btn btn-default" onclick="changeUser(this, '${user.uName}')"><i class="fa fa-pencil"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                    ...
                                    <div class="text-center">
                                        <nav>
                                            <ul class="pagination myPagination">
                                                <li class="page-item">
                                                    <a class="page-link" href="<c:url value="/UserManagerServlet?currentPage=1"/>">首页</a>
                                                </li>
                                                <li class="page-item">
                                                    <a class="page-link" href="<c:url value="/UserManagerServlet?currentPage=${currentPage-1>1?currentPage-1:1}"/>" aria-label="Previous">
                                                ...
                                                <c:forEach begin="1" end="${totalPages}" varStatus="s">
                                                    ...
                                                    <li class="page-item ${active}">
                                                        <a class="page-link" href="<c:url value="/UserManagerServlet?currentPage=${s.index}"/>">${s.index}</a>
                                                    </li>
                                                </c:forEach>
                                                <li class="page-item">
                                                    <a class="page-link" href="<c:url value="/UserManagerServlet?currentPage=${currentPage+1<totalPages?currentPage+1:totalPages}"/> " aria-label="Next">
                                                        <span aria-hidden="true">&raquo;</span>
                                                        <span class="sr-only">Next</span>
                                                    </a>
                                                </li>
                                                <li class="page-item">
                                                    <a class="page-link" href="<c:url value="/UserManagerServlet?currentPage=${totalPages}"/> ">尾页</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    </div>
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form id="form1" name="form1" style="margin-left: 50px; margin-right: 50px">
                                            ...
                                            <div class="form-group">
                                                <input type='hidden' value='CompanyUser' name='identify'>
                                            </div>
                                            <div class="text-center">
